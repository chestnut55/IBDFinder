...
cut = int(0.9*np.shape(expression)[0])
...
# accuracy_list = list()
# auc_list = list()
# for train_idx,test_idx in cv.split(expression, label_vec):
#     x_train,x_test = expression[train_idx],expression[test_idx]
#     y_train,y_test = label_vec[train_idx],label_vec[test_idx]
#
#     y_train_labels = []
#     for l in y_train:
#         if l == 1:
#             y_train_labels.append([0, 1])
#         else:
#             y_train_labels.append([1, 0])
#     y_train = np.array(y_train_labels, dtype=int)
#
#     y_test_labels = []
#     for l in y_test:
#         if l == 1:
#             y_test_labels.append([0, 1])
#         else:
#             y_test_labels.append([1, 0])
#     y_test = np.array(y_test_labels, dtype=int)
...
with tf.Session() as sess:
    ...
    acc = round(acc,3)
    auc = round(metrics.roc_auc_score(y_test, y_s),3)
